    ...
    <div className="bg-white">
      <div className="wrap py-10">
        ...
        <div className="border-b border-[#E0E0E0] pb-6 mb-8">
          <p className="eyebrow">Los más vendidos</p>
          <h1 className="mt-2 text-4xl font-black text-ink sm:text-5xl">Best Sellers</h1>
          {hydrated && (
            <p className="mt-1 text-sm text-muted">{bestSellers.length} referencias</p>
          )}
        </div>
